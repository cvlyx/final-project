...
<body>
    <div class="login-container">
        <div class="glass-card">
            ...
            ?>
            <form id="loginForm" action="../auth/loginprocess.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        minlength="8"
                    >
                    <a href="../auth/forget.php" style="display: block; text-align: right; margin-top: 0.5rem; color: var(--secondary-color); font-size: 0.9rem;">Forgot Password?</a>
                </div>
            ...
            <div class="login-footer">
                <p>New student? <a href="../public/admission.php">Apply for admission</a> to get your credentials</p>
            </div>
        </div>
    </div>
